...
{ 
	...
	{  		
		...
		public static function toRGBint(rgb:Array):uint{
		...
		{
			var r:Number = toRGB(rgb)[0];
			var g:Number = toRGB(rgb)[1];
			var b:Number = toRGB(rgb)[2];
		...
		public static function toString(color:uint):String{
			var result:String = color.toString(16).toUpperCase();
